...
<div class="element-wrapper">
                    ...
                    <div style="line-height: 25%;">
                        <p style="margin-bottom:20px;"> Drivers Assigned to {{Auth::user()->name}} :{{$driver_assigned->count()}} --> <p></p> @foreach($driver_assigned as $driver_assigne)<span style="margin-bottom:25px;">{{$driver_assigne->name}} &nbsp; &nbsp;| &nbsp; &nbsp;</span>@endforeach</p>
                         <p style="margin-bottom:20px;">Available Drivers:{{$driver_onlines->count()}} -->  <p></p> @foreach($driver_onlines as $driver_online)<span>{{$driver_online->name}} &nbsp; &nbsp;| &nbsp; &nbsp;</span>@endforeach</p>
                        <p style="margin-bottom:20px;">  Drivers On Trip:{{$driver_ontrips->count()}}  -->  <p></p> @foreach($driver_ontrips as $driver_ontrip)<span>{{$driver_ontrip->name}} &nbsp; &nbsp;| &nbsp; &nbsp;</span>@endforeach </p>
                        <p style="margin-bottom:20px;">Offline Drivers:{{$driver_offlines->count()}}  -->  <p></p> @foreach($driver_offlines as $driver_offline)<span>{{$driver_offline->name}} &nbsp; &nbsp;| &nbsp; &nbsp;</span>@endforeach</p>
                    </div>
