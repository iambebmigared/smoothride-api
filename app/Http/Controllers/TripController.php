...
class TripController extends Controller
{
    ...
    public function index()
    {
        ...
        $trips =  Trip::where(['parent_code' => Auth::user()->unique_code, 'tripRequest' => 'approved', 'flag' => 0])->paginate(30);
        //dd($trips);
    ...
    $trips =  Trip::whereBetween('created_at', [$from, $to])->where(['parent_code' => Auth::user()->unique_code, 'tripRequest' => 'approved', 'flag' => 0])->get();
    // $trips =  Trip::whereBetween('created_at', [$from, $to])->where(['parent_code' => Auth::user()->unique_code, 'tripRequest' => 'approved', 'flag' => 0])->paginate(10);
