...
Route::post('uncaps/store','UserController@storee')->name('uncaps.store');
Route::get('/uncaps/dashboard','UserController@indexx');
...
Route::post('/BMDriver-search', 'BMController@searchTripp')->name('bm.searchTripp');

// Flagged Trips
Route::get('/flagged-index', 'FlaggedController@index')->name('flagged.index');
Route::get('/unflag-trip/{id}', 'FlaggedController@unflagTrip')->name('flagged.unflag');
Route::get('/unflag-trip/{id}/edit', 'FlaggedController@edit')->name('flagged.edit.get');
Route::post('/unflag-trip/{id}/edit', 'FlaggedController@update')->name('flagged.edit.post');
